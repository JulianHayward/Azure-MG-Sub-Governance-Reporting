...
* Go to '__Access Control__', '__Grant Access__' and '__Add Role Assignment__', select '__Reader__', click '__Next__'
...
**Note: if you do not assign the rights to the Management group, the '__Verify__' step below will fail.**
