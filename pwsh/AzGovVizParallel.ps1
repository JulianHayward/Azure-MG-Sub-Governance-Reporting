...
$APICallTrackingRetriesCount = ($arrayAPICallTracking.where( { $_.TryCounter -gt 1 } )).Count
$APICallTrackingGroupedByTargetEndpoint = $arrayAPICallTracking | Group-Object -Property TargetEndpoint
...
$duarationStats = ($arrayAPICallTracking.Duration | Measure-Object -Average -Maximum -Minimum)
