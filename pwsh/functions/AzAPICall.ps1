function AzAPICall {
    ...
    .PARAMETER getGroupMembersCount
    Parameter description
    ...
    .PARAMETER getMgAscSecureScore
    Parameter description

    .PARAMETER getRoleAssignmentSchedules
    Parameter description

    .PARAMETER getDiagnosticSettingsMg
    Parameter description
    ...
    .PARAMETER getDiagnosticSettingsResource
    Parameter description
    ...
    param (
        ...
        [Parameter(Mandatory = $False)][switch]$getDiagnosticSettingsResource,
        ...
        if ($unexpectedError -eq $false) {
            ...
            if ($azAPIRequest.StatusCode -ne 200) {
                ...
                if ($catchResult.error.code -like "*GatewayTimeout*" -or
                    ...
                    ($getDiagnosticSettingsResource -and $catchResult.error.code -like "*ResourceNotFound*") -or 
                    ($getDiagnosticSettingsResource -and $catchResult.code -like "*ResourceNotFound*") -or 
                    ($getDiagnosticSettingsResource -and $catchResult.error.code -like "*ResourceGroupNotFound*") -or 
                    ($getDiagnosticSettingsResource -and $catchResult.code -like "*ResourceGroupNotFound*") -or
                    ($getDiagnosticSettingsResource -and $catchResult.code -eq "ResourceTypeNotSupported")
                ) {
                    ...
                    if ($getDiagnosticSettingsResource -and ($catchResult.error.code -like "*ResourceNotFound*" -or $catchResult.code -like "*ResourceNotFound*" -or $catchResult.error.code -like "*ResourceGroupNotFound*" -or $catchResult.code -like "*ResourceGroupNotFound*" -or $catchResult.code -eq "ResourceTypeNotSupported")) {
